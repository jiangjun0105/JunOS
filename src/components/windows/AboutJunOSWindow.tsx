  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-[18px] text-muted">
        ...
        real — drag the title bar to move it, pull the bottom-right corner to resize, and minimize
        it to the tray in the top-right.
      </p>
      <p className="text-[18px]">
        It&apos;s a love letter to the desktops we grew up with, dressed in a warm, hand-drawn
        theme. No heavy UI frameworks — just React, a tiny hand-rolled window manager, and a lot of
        care for the small details.
      </p>
      <p className="text-[18px]">
        Wander through the apps to read articles, browse files, or peek at projects. Every window is
        deep-linkable, so you can share exactly what you&apos;re looking at just by copying the
        address bar.
      </p>
      <ChipRow
        items={[
